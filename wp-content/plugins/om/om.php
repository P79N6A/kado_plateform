<?php
/**
 * Plugin Name: Orange Money WooCommerce Offline Gateway
 * Plugin URI: https://www.viecity.com/?p=3343
 * Description: Plugin de paiement Orange Money Cameroun
 * Author: MVONDO Yannick
 * Author URI: http://www.viecity.com/
 * Version: 0.0.1
 * Text Domain: om-wc-gateway-offline
 * Domain Path: /i18n/languages/
 *
 * Copyright: (c) 2015-2016 MVONDO Yannick, Orange Money and WooCommerce
 *
...
function wc_offline_gateway_init() {
	...
	class WC_Gateway_Offline extends WC_Payment_Gateway {
		...
		public function __construct() {
			...
			$this->icon               = apply_filters('woocommerce_offline_icon', 'https://www.orange.cm/particuliers/1/25/72.jpg');
			$this->has_fields         = false;
			$this->method_title       = __( 'ORANGE MONEY', 'wc-gateway-offline' );
		...
		public function init_form_fields() {
			...
			$this->form_fields = apply_filters( 'wc_offline_form_fields', array(
				...
				'enabled' => array(
					'title'   => __( 'Activer/Desactiver', 'wc-gateway-offline' ),
					'type'    => 'checkbox',
					'label'   => __( 'Activer Orange Money', 'wc-gateway-offline' ),
					'default' => 'yes'
				),
				...
				'title' => array(
					...
					'default'     => __( 'Orange Money', 'wc-gateway-offline' ),
					'desc_tip'    => true,
				),
				...
				'description' => array(
					...
					'default'     => __( 'Please rdemit payment to Store Name upon pickup or delivery.', 'wc-gateway-offline' ),
					'desc_tip'    => true,
				),
