        ...
        public static function options_page() {
            ...
            <div class="wrap woocommerce">
                ...
                <table class="form-table">
                    ...
                    <!--Next Invoice Number -->
<?php
                    if( NULL !== $woocommerce_pdf_invoice_options['pdf_next_number'] && $woocommerce_pdf_invoice_options['pdf_next_number'] > get_option( 'woocommerce_pdf_invoice_current_invoice' ) ) {
                        $next_invoice = $woocommerce_pdf_invoice_options['pdf_next_number'];
                    } else {
                        $next_invoice = get_option( 'woocommerce_pdf_invoice_current_invoice' ) + 1;
                    }
?>
                    <tr valign="top">
                        <th scope="row" class="titledesc">
                        ...
                        <td class="forminp forminp-number">
                            ...
                            <p><?php _e('Take care changing this number, you may be breaking your local tax law by having gaps in your invoice numbers. You can only increase the number, decreasing it could lead to duplicate invoice numbers. ', 'woocommerce-pdf-invoice' ); ?></p>                  
                        </td>
                    </tr>
