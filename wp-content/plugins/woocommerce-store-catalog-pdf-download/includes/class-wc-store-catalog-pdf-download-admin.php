...
class WC_Store_Catalog_PDF_Download_Admin {
	...
	public function get_settings() { 
		...
		<table class="form-table">
			<tbody>
				<tr valign="top">
					<th class="titledesc" scope="row"><?php _e( 'Custom PDF', 'woocommerce-store-catalog-pdf-download' ); ?><img class="help_tip" data-tip="<?php esc_attr_e( 'Upload a ready made PDF of your store.', 'woocommerce-store-catalog-pdf-download' ); ?>" src="<?php echo $help_icon; ?>" height="16" width="16" /></th>
		...
		<table class="form-table">
			<tbody>
				<tr valign="top">
					<th class="titledesc" scope="row"><?php _e( 'Company Logo', 'woocommerce-store-catalog-pdf-download' ); ?><img class="help_tip" data-tip="<?php esc_attr_e( 'Upload a logo to be shown at the top of the PDF.', 'woocommerce-store-catalog-pdf-download' ); ?>" src="<?php echo $help_icon; ?>" height="16" width="16" /></th>
				...
				<tr valign="top">
					<th class="titledesc" scope="row"><?php _e( 'PDF Layout Format', 'woocommerce-store-catalog-pdf-download' ); ?><img class="help_tip" data-tip="<?php esc_attr_e( 'Set how you want the PDF layout format to display for category products.', 'woocommerce-store-catalog-pdf-download' ); ?>" src="<?php echo $help_icon; ?>" height="16" width="16" /></th>
					<td class="forminp">
				...
				<tr valign="top">
					<th class="titledesc" scope="row"><?php _e( 'Download Link Label', 'woocommerce-store-catalog-pdf-download' ); ?><img class="help_tip" data-tip="<?php esc_attr_e( 'Set the text you want to display next to the download icon.', 'woocommerce-store-catalog-pdf-download' ); ?>" src="<?php echo $help_icon; ?>" height="16" width="16" /></th>
					<td class="forminp">
